...
[plans/PDA-DEC-rulings.md](PDA-DEC-rulings.md), 58 entries at close, all binding —
...
`ParseEnvelopeBody` refuses a NUL key → `return false` beside its bounds
