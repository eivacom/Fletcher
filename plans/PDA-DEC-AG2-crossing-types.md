...
Rule 2 is true by construction, not asserted: `PubSubError`'s constructor escapes any NUL as
`\x00` — the *coerce-don't-throw* shape §5.1 already mandates for a refused status; the
