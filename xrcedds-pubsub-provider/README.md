...
Both platforms produce a separate binary package. Each build job saves its package to a GitHub Actions artifact; the `upload` job downloads both, restores them into the Conan cache, and attaches them as GitHub Release assets:
