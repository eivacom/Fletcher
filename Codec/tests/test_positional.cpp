...
TEST(PositionalTest, BooleanRoundtrip) {
...
TEST(PositionalTest, IntegerRoundtrip) {
...
TEST(PositionalTest, FloatRoundtrip) {
...
TEST(PositionalTest, StringAndBinaryRoundtrip) {
...
TEST(PositionalTest, TemporalTypesRoundtrip) {
...
TEST(PositionalTest, DecimalRoundtrip) {
...
TEST(PositionalTest, NullFields) {
...
TEST(PositionalTest, AllNullFields) {
    auto schema = arrow::schema({
        arrow::field("a", arrow::int32(), true),
        arrow::field("b", arrow::utf8(), true),
    });
...
TEST(PositionalTest, MultiFieldRowRoundtrip) {
    auto schema = arrow::schema({
...
TEST(PositionalTest, StructRoundtrip) {
...
TEST(PositionalTest, StructWithNullChild) {
    auto stype = arrow::struct_({
...
TEST(PositionalTest, ListRoundtrip) {
...
TEST(PositionalTest, ListWithNulls) {
    auto list_type = arrow::list(arrow::int32());
    auto schema = arrow::schema({arrow::field("nums", list_type)});
    fletcher::PositionalCodec codec(schema);
...
TEST(PositionalTest, FixedSizeListRoundtrip) {
...
TEST(PositionalTest, MapRoundtrip) {
...
TEST(PositionalTest, DenseUnionRoundtrip) {
...
TEST(PositionalTest, SmallerWireSizeThanTaggedFormat) {
    auto schema = arrow::schema({
        arrow::field("id", arrow::int32()),
    ...
    SCOPED_TRACE("Positional size: " + std::to_string(positional_encoded.size()));
    EXPECT_LT(positional_encoded.size(), 50u);  // much smaller than ~109
}
...
TEST(PositionalTest, NinePlusFieldsUseMultiByteNullBitfield) {
